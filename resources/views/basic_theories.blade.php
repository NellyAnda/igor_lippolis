...
@section('content')
  <h2>Teorias basicas de la medicina tradicional China</h2>
    ...
    <div class="basic_theories_containers">
      <div>
        <img src="{{asset('images/five_elements.png')}}" alt="images de los cinco elementos o cinco fases">
      </div>
      <div>
        <div>
    ...
    <div class="dark_background">
      <div class="basic_theories_containers">
        <div>
          <div class="five_elements_containers">
    ...
    <div class="basic_theories_containers">
      <p>La teoría de las <span class="colored_emphasis">Cinco Fases</span> sirve de importante apoyo a la fisiología, etiología y fisiopatología de la medicina china pero, más allá de ser una herramienta teórica de utilidad, su aplicación clínica adquiere especial importancia en el <span class="colored_emphasis">diagnóstico</span> y <span class="colored_emphasis">tratamiento</span>.</p>
      <ul>
      ...
      <p>En el <span class="colored_emphasis">tratamiento con materias medicinales</span>, se utilizan los sabores para penetrar en esferas funcionales concretas, es decir, por ejemplo, utilizaremos el sabor amargo para ‘entrar’ en el corazón y reducir el fuego o el sabor salado para estabilizar el riñón.</p>
    </div>
@endsection
