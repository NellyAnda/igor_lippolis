...
<p class="treatment_duration">Duración aproximada de tratamiento : 20/30min</p>
...
<div class="dark_background">
  ...
  <div class="bottom_spacing">
    <h3>Acupuntura Craneal</h3>
    <p>Por <span class="colored_emphasis">acupuntura craneal</span> o <span class="colored_emphasis">craneopuntura</span> se entiende un conjunto de técnicas terapéuticas que se basan en la utilización de agujas de acupuntura para estimular líneas áreas o puntos en la región de la calota craneana.</p>
    ...
    <p>Duración aproximada de tratamiento : 20/30min</p>
  </div>
</div>
...
<div>
  <div>
    <p>La acupuntura es una técnica antigua utilizada por los ancestros para el cuidado de la salud. La unión de <span class="colored_emphasis">acupuntura</span> y la <span class="colored_emphasis">estética</span> ha resultado un excelente descubrimiento para la <span class="colored_emphasis">medicina estética</span>, en beneficio de los profesionales de esta rama y de los pacientes que recurren a ella en busca de una solución a su problema <span class="colored_emphasis">sin recurrir a tratamientos químicos</span>.</p>
    <p>La <span class="colored_emphasis">acupuntura estética</span> a diferencia de otros ratamientos esteticos, trata desde la profundidad, <span class="colored_emphasis">estimula directamente las células y los tejidos profundos</span>. Además de actuar en el orígen del problema, la acupuntura activa la circulación de los fluidos del cuerpo, oxigenando, nutriendo y estimulando los tejidos.<br>
      Se trata de una tecnica que <span class="colored_emphasis">no duele</span>. Se utiliza una aguja muy fina del grosor de un cabello, recubierta de silicio y desechable que reduce el dolor al mínimo, la sensación podría ser equivalente a la picada de un mosquito.</p>
      
    </div>
    <div>
      <img src="{{asset('images/head_massage.png')}}" class="" alt="imagen de una mujer recibiendo un masaje de cabeza">
    </div>
  </div>
