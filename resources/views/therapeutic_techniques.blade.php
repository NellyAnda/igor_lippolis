...
<div class="acupuncture_bottom_container">
  ...
  <div>
    <img src="{{asset('images/moxibustion.png')}}" class="top_spacing" alt="imagen de una mujer recibiendo un masaje de cabeza">
  </div>
</div>
<div class="light_background acupuncture_top_container">
  <div>
    <img src="{{asset('images/suction_cup.png')}}" class="acupuncture_picture" alt="imagen de dos maniquíes que muestran puntos de acupuntura">
  </div>
...
<div class="acupuncture_bottom_container">
  ...
  <div>
    <img src="{{asset('images/acupuncture_needles.png')}}" class="top_spacing" alt="imagen de una mujer recibiendo un masaje de cabeza">
  </div>
</div>
<div class="dark_background acupuncture_top_container">
  <div>
    <img src="{{asset('images/ear_acupuncture.png')}}" class="acupuncture_picture" alt="imagen de dos maniquíes que muestran puntos de acupuntura">
  </div>
  <div class="bottom_spacing acupuncture_text_containers">
...
<div class="acupuncture_bottom_container">
  ...
  <div>
    <img src="{{asset('images/back_massage.png')}}" class="top_spacing" alt="imagen de una mujer recibiendo un masaje de cabeza">
  </div>
</div>
<div class="light_background acupuncture_top_container">
  <div>
    <img src="{{asset('images/food.png')}}" class="acupuncture_picture" alt="imagen de dos maniquíes que muestran puntos de acupuntura">
  </div>
  <div class="bottom_spacing acupuncture_text_containers">
...
<div class="acupuncture_bottom_container">
  <div class="acupuncture_text_containers">
    ...
    <p>Al comprender las similitudes exactas entre las diferentes áreas del cuerpo y las manos y los pies se puede influir en cualquier problema utilizando la combinación de puntos correspondiente.</p>
  </div>
  <div>
    <img src="{{asset('images/hand_massage.png')}}" class="top_spacing" alt="imagen de una mujer recibiendo un masaje de cabeza">
  </div>
</div>
<div class="dark_background acupuncture_top_container">
  <div>
    <img src="{{asset('images/chinese_teapot_on_a_bamboo_surface.png')}}" class="acupuncture_picture" alt="imagen de dos maniquíes que muestran puntos de acupuntura">
  </div>
  <div class="bottom_spacing acupuncture_text_containers">
