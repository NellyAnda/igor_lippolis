...
@section('pageTitle', 'Tecnicas Terapeuticas')
...
<div class="therapies_colorless_containers">
  <div class="therapies_text_containers">
    <h3 class="top_spacing">Moxibustión</h3>
...
<div class="light_background therapies_colored_containers">
  ...
  <div class="bottom_spacing therapies_text_containers">
    <h3 class="top_spacing">Ventosas</h3>
...
<div class="therapies_colorless_containers">
  <div class="therapies_text_containers">
    <h3 class="top_spacing">Electroacupuntura</h3>
...
<div class="therapies_colorless_containers">
  <div class="therapies_text_containers">
    <h3 class="top_spacing">Tui Na</h3>
...
<div class="light_background therapies_colored_containers">
  ...
  <div class="bottom_spacing therapies_text_containers">
    <h3 class="top_spacing">Fitoterapia china</h3>
...
<div class="therapies_colorless_containers">
  <div class="therapies_text_containers">
    <h3 class="top_spacing">Su Jok</h3>
...
<div class="dark_background therapies_colored_containers">
  ...
  <div class="therapies_text_containers">
    <h3 class="top_spacing">Dietética según Yin Yang</h3>
